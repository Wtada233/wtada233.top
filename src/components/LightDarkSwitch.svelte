...
import moonIcon from "@iconify-icons/material-symbols/dark-mode-outline-rounded";
import autoIcon from "@iconify-icons/material-symbols/radio-button-partial-outline";
import sunIcon from "@iconify-icons/material-symbols/wb-sunny-outline-rounded";
...
<div class="relative z-50" role="menu" tabindex="-1" onmouseleave={hidePanel}>
    <button aria-label="Light/Dark Mode" role="menuitem" class="relative btn-plain scale-animation rounded-lg h-11 w-11 active:scale-90" id="scheme-switch" onclick={toggleScheme} onmouseenter={showPanel}>
        ...
        <div class="absolute" class:opacity-0={mode !== AUTO_MODE}>
            <Icon icon={autoIcon} class="text-[1.25rem]"></Icon>
        </div>
    </button>
    ...
    <div id="light-dark-panel" class="hidden lg:block absolute transition float-panel-closed top-11 -right-2 pt-5" >
        <div class="card-base float-panel p-2">
            ...
            >
                <Icon icon={autoIcon} class="text-[1.25rem] mr-3"></Icon>
