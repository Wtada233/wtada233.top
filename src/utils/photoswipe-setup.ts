...
function initLightbox() {
	...
	const currentLang = document.documentElement.getAttribute("data-lang") || siteConfig.lang;
	const gallerySelector = `.translation-unit[data-unit-lang="${currentLang}"] img, #post-cover img`;
...
const cleanupLightbox = (): void => {
	lightbox?.destroy?.();
};

export function initPhotoSwipe(): void {
	setupComponent("PhotoSwipe", initLightbox, cleanupLightbox);
}
