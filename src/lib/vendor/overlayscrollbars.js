...
const hasOwnProperty = (t, n) => Object.hasOwn(t, n);
...
const parseToZeroOrNumber = (t) => validFiniteNumber(Number.parseFloat(t || ""));
...
const getFractionalSize = (t) => {
	const n = Number.parseFloat(getStyles(t, C)) || 0;
	const o = Number.parseFloat(getStyles(t, $)) || 0;
	return {
		w: n - e(n),
		h: o - e(o),
	};
...
const zt = /* @__PURE__ */ (() => ({
	[Et]: {
		static: () => (t, n, o, s) => {
			...
			const linearPressAnimation = (o, s) =>
				animateNumber(o, n - f, r * s, (o, s, e) => {
					t(o);
					if (e) {
						c = easedEndPressAnimation(o, n);
					}
				});
			const d = animateNumber(
				0,
				f,
				i,
				(r, i, a) => {
...
const createObserversSetup = (t, n, o, s) => {
	...
	const M =
		!S &&
		createSizeObserver(h, onSizeChanged, {
			ft: true,
		});
...
const createScrollbarsSetup = (t, n, o, s, e, c) => {
	...
	const [m, O] = createScrollbarsSetupElements(
		t,
		e,
		s,
		createScrollbarsSetupEvents(n, e, s, (t) => isHoverablePointerType(t) && manageScrollbarsAutoHideInstantInteraction()),
	);
...
const createStructureSetupElements = (t) => {
	...
	const appendElements = () => {
		...
		const prepareWrapUnwrapFocus = (t) =>
			addEventListener(t, "focusin focusout focus blur", stopAndPrevent, {
				A: true,
				I: false,
			});
		const o = "tabindex";
...
const createOverflowUpdateSegment = (t, s) => {
	...
	const setViewportOverflowStyle = (t) => {
		...
		d(
			keys(t)
				.map((n) => createViewportOverflowStyleClassName(t[n], n === "x"))
				.join(" "),
			true,
		);
	};
