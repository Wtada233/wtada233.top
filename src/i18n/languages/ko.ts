...
export const ko: Translation = {
	...
	[Key.langMismatchNotice]: "기본 언어가 한국어로 감지되었습니다.",
	[Key.langMismatchConfirm]: "한국어로 전환",

	// Webmentions
	[Key.webmentions]: "웹멘션",
	[Key.noWebmentions]: "웹멘션 없음",
	[Key.failedToLoadWebmentions]: "웹멘션 로드 실패",
	[Key.likes]: "좋아요",
	[Key.reposts]: "리포스트",
	[Key.mentions]: "멘션",
