...
import { expressiveCodeConfig } from "./src/configs/expressive-code.ts";
import { pwaConfig } from "./src/configs/pwa.ts";
import { siteConfig } from "./src/configs/site.ts";
...
export default defineConfig({
	...
	integrations: [
		...
		AstroPWA({
			...
			workbox: {
				globPatterns: ['**/*.{js,css,html,ico,png,svg,txt,visual,woff,woff2,json}'],
				globIgnores: ['404.html'],
				navigateFallback: null,
				cleanupOutdatedCaches: true,
			},
			experimental: {
				directoryAndIndex: true,
			},
		}),
	],
	...
	build: {
		...
		environmentVariables: {
			PUBLIC_BUILD_DATE: new Date().toISOString(),
		},
	},
});
